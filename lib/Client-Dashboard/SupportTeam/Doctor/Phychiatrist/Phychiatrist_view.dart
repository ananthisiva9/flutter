...
import 'Phychiatrist_controller.dart';

class Phychiatrist extends StatefulWidget {
  @override
  _PhychiatristState createState() => _PhychiatristState();
}

class _PhychiatristState extends State<Phychiatrist> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => PhychiatristController(context),
      child: Consumer<PhychiatristController>(
                    ...
                    : controller.state == StateEnum.success
                        ...
                        : Center(
                            child: ErrorRefreshIcon(onPressed: () {
                              controller.fetchAllPhychiatrist();
                            }),
                          ),
              ],
            ),
