...
class PhychiatristController with ChangeNotifier {
  PhychiatristController(this.context) {
    fetchAllPhychiatrist();
  }
  ...
  fetchAllPhychiatrist() async {
    changeState(StateEnum.loading);
    LoginModel? userdetails = await Global.getUserDetails();
    if (userdetails != null) {
      if (userdetails.token != null) {
        String url = clientApi.doctor_filter_get + "?speciality=psychiatrist";
