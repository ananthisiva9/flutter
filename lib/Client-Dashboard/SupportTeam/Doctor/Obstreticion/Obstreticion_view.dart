...
import 'Obstreticion_controller.dart';

class Obstreticion extends StatefulWidget {
  @override
  _ObstreticionState createState() => _ObstreticionState();
}

class _ObstreticionState extends State<Obstreticion> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ObstreticionController(context),
      child: Consumer<ObstreticionController>(
                    ...
                    : controller.state == StateEnum.success
                        ...
                        : Center(
                            child: ErrorRefreshIcon(onPressed: () {
                              controller.fetchAllObstreticion();
                            }),
                          ),
              ],
            ),
