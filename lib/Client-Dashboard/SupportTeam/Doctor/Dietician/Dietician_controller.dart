...
class DieticianController with ChangeNotifier {
  DieticianController(this.context) {
    fetchAllDietician();
  }
  ...
  fetchAllDietician() async {
    changeState(StateEnum.loading);
    LoginModel? userdetails = await Global.getUserDetails();
    if (userdetails != null) {
      if (userdetails.token != null) {
        String url = clientApi.doctor_filter_get + "?speciality=dietician";
