...
import 'Dietician_controller.dart';
...
class _DieticianState extends State<Dietician> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => DieticianController(context),
      child:
          Consumer<DieticianController>(builder: (context, controller, child) {
        return SafeArea(
          child: Scaffold(
