...
class PhycologistController with ChangeNotifier {
  PhycologistController(this.context) {
    fetchAllPhycologist();
  }
  ...
  fetchAllPhycologist() async {
    changeState(StateEnum.loading);
    LoginModel? userdetails = await Global.getUserDetails();
    if (userdetails != null) {
      if (userdetails.token != null) {
        String url = clientApi.doctor_filter_get + "?speciality=psychologist";
