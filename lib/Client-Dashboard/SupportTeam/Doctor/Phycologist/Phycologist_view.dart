...
import 'Phycologist_controller.dart';

class Phycologist extends StatefulWidget {
  @override
  _PhycologistState createState() => _PhycologistState();
}

class _PhycologistState extends State<Phycologist> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => PhycologistController(context),
      child: Consumer<PhycologistController>(
                    ...
                    : controller.state == StateEnum.success
                        ...
                        : Center(
                            child: ErrorRefreshIcon(onPressed: () {
                              controller.fetchAllPhycologist();
                            }),
                          ),
              ],
            ),
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => BookAppointment(item)),
                            );
                          },
                          child: Text(
                            "Book Appointment",
