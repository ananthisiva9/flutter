...
class PaediatricianController with ChangeNotifier {
  PaediatricianController(this.context) {
    fetchAllPaediatricians();
  }
  ...
  fetchAllPaediatricians() async {
    changeState(StateEnum.loading);
    LoginModel? userdetails = await Global.getUserDetails();
    if (userdetails != null) {
      if (userdetails.token != null) {
        String url =
            clientApi.doctor_filter_get + "?speciality=pediatrician";
