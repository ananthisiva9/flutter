...
class UpcomingScanDateController with ChangeNotifier {
  UpcomingScanDateController(this.context) {
    fetchAllUpcomingScanDate();
  }
  BuildContext context;
  UpcomingScanDateModel? model;
  ...
  fetchAllUpcomingScanDate() async {
    changeState(StateEnum.loading);
    LoginModel? userdetails = await Global.getUserDetails();
    if (userdetails != null) {
      if (userdetails.token != null) {
        String url = clientApi.upcomingScanDate_get;
        ...
        if (response is bool) {
          ...
          model = UpcomingScanDateModel.fromJson(response);
          print(response);
