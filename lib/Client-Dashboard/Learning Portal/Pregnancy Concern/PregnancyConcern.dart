...
class _ConcernState extends State<Concern> {
  ...
  note(String notes) async {
    String url = "https://sukhprasavam.shebirth.com/learning/add-notes/";
    Map body = {"module": "pregnancy concerns ", "notes": notes};
  ...
  fetchNotes() async {
    ...
    if (token != null) {
      final response = await http.get(
          Uri.parse(
              "https://sukhprasavam.shebirth.com/learning/get-module-data/?module=pregnancy concerns"),
          headers: {'Authorization': "Token $token"});
