...
class PlanningBirth extends StatefulWidget {
  @override
  _PlanningBirthState createState() => _PlanningBirthState();
}

class _PlanningBirthState extends State<PlanningBirth> {
  var url, notes;
  ...
  note(String notes) async {
    ...
    Map body = {"module": "planning birth", "notes": notes};
  ...
  fetchData() async {
    String? token = await getToken();
    String url = clientApi.video + "?module=planning birth";
    if (token != null) {
