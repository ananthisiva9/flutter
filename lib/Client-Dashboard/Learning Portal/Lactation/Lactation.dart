...
class Lactation extends StatefulWidget {
  @override
  _LactationState createState() => _LactationState();
}

class _LactationState extends State<Lactation> {
  var url, notes;
  ...
  note(String notes) async {
    ...
    Map body = {"module": "lactation", "notes": notes};
  ...
  fetchData() async {
    String? token = await getToken();
    String url = clientApi.video + "?module=lactation";
    if (token != null) {
