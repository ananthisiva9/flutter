...
class CopingTechnique extends StatefulWidget {
  @override
  _CopingTechniqueState createState() => _CopingTechniqueState();
}

class _CopingTechniqueState extends State<CopingTechnique> {
  var url, notes;
  ...
  note(String notes) async {
    ...
    Map body = {"module": "natural coping", "notes": notes};
  ...
  fetchData() async {
    String? token = await getToken();
    String url = clientApi.video + "?module=natural coping";
    if (token != null) {
