...
class DataSearch extends SearchDelegate<ApprovalRequestItem?> {
  DataSearch(this.clients);
  List<ApprovalRequestItem> clients;

  List<ApprovalRequestItem> filteredclients = [];
  @override
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if (query.isEmpty) {
      ...
      if (filteredclients.isEmpty) {
        filteredclients = clients
            .where((element) => (element.clientName != null &&
