...
class Pelvis extends StatefulWidget {
  Pelvis(this.controller);
  SymptomController controller;

  @override
  State<Pelvis> createState() => _PelvisState();
}

class _PelvisState extends State<Pelvis> {
  List<Symptom> ll = [];
  ...
  void initState() {
    ...
    for (int i = 0; i < widget.controller.allSymptom.length; i++) {
      if (widget.controller.allSymptom[i].category == "Pelvis") {
        ll.add(Symptom(
