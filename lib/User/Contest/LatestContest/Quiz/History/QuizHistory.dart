...
class _QuizHistoryState extends State<QuizHistory> {
  ...
  void getData(parapage) async {
    ...
    var baseUrl = '${ApiEndPoint.quiz_history}?history=${widget.id}';
    var response = await http.get(
      Uri.parse(baseUrl),
      headers: {"Authorization": "Token $token"},
    );

    QuizHistoryModel model =
        QuizHistoryModel.fromJson(jsonDecode(response.body));
                  ...
                  children: [
                   ...
                   isLoading
                        ...
                        : result.isEmpty
                            ?
                                  Text(
                                    "No Quiz Contest Data Available",
