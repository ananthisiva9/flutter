...
import 'History/QuizHistory.dart';

class LatestQuizContest extends StatefulWidget {
  String id;
  LatestQuizContest(this.id);
  @override
  State<LatestQuizContest> createState() => _LatestQuizContestState();
}

class _LatestQuizContestState extends State<LatestQuizContest>
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        if (result[index]
                                                          ...
                                                          Navigator.push(
                                                            context,
                                                            MaterialPageRoute(
                                                                builder: (context) => QuizContestRule(
                                                                    result[index]
                                                                        .id
                                                                        .toString(),
                                                                    result[index]
