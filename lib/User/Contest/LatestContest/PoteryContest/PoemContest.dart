...
import 'History/PoemHistory.dart';

class LatestPoemContest extends StatefulWidget {
  String id;
  LatestPoemContest(this.id);
  @override
  State<LatestPoemContest> createState() => _LatestPoemContestState();
}

class _LatestPoemContestState extends State<LatestPoemContest>
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        if (result[index]
                                                          ...
                                                          Navigator.push(
                                                            context,
                                                            MaterialPageRoute(
                                                                builder: (context) => PoetryContestRule(
                                                                    result[index]
                                                                        .id
                                                                        .toString(),
                                                                    result[index]
