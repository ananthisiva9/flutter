...
import 'History/ImageHistory.dart';

class LatestImageContest extends StatefulWidget {
  String id;
  LatestImageContest(this.id);
  @override
  State<LatestImageContest> createState() => _LatestImageContestState();
}

class _LatestImageContestState extends State<LatestImageContest>
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        if (result[index]
                                                          ...
                                                          Navigator.push(
                                                            context,
                                                            MaterialPageRoute(
                                                                builder: (context) => ImageContestRules(
                                                                    result[index]
                                                                        .id,
                                                                    result[index]
                                                                        .contestType,
