...
import 'History/AppNameHistory.dart';

class LatestAppNameContest extends StatefulWidget {
  String id;
  LatestAppNameContest(this.id);
  @override
  State<LatestAppNameContest> createState() => _LatestAppNameContestState();
}

class _LatestAppNameContestState extends State<LatestAppNameContest>
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      CrossAxisAlignment
                                                          .center,
                                                      children: [
                                                        const Icon(Icons.timer_off_outlined,color:Colors.white,size: 25),
                                                        Padding(
                                                          padding: const EdgeInsets.all(8.0),
                                                          child: Center(
                                                            child: Text(
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        if (result[index]
                                                          ...
                                                          Navigator.push(
                                                              context,
                                                              MaterialPageRoute(
                                                                  builder: (context) => AppNameContestRule(
                                                                      result[index]
                                                                          .id
                                                                          .toString(),
                                                                      result[index]
