...
class PreviousAppNameContest extends StatefulWidget {
  String id;
  PreviousAppNameContest(this.id);
  @override
  State<PreviousAppNameContest> createState() => _PreviousAppNameContestState();
}

class _PreviousAppNameContestState extends State<PreviousAppNameContest> {
  bool loading = true;
  List<Datum> result = [];
  bool isLoading = true;
  @override
