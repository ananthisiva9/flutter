...
class PreviousImageContest extends StatefulWidget {
  String id;
  PreviousImageContest(this.id);
  @override
  State<PreviousImageContest> createState() => _PreviousImageContestState();
}

class _PreviousImageContestState extends State<PreviousImageContest> {
  bool loading = true;
  List<Datum> result = [];
  bool isLoading = true;
  @override
