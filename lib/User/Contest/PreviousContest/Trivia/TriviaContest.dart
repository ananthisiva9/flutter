...
import 'Trivia_history.dart';

class PreviousTriviaContest extends StatefulWidget {
  String id;
  PreviousTriviaContest(this.id);
  @override
  State<PreviousTriviaContest> createState() => _PreviousTriviaContestState();
}

class _PreviousTriviaContestState extends State<PreviousTriviaContest> {
  bool loading = true;
  List<Datum> result = [];
  bool isLoading = true;
  @override
