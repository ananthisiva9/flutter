...
class PreviousQuizContest extends StatefulWidget {
  String id;
  PreviousQuizContest(this.id);
  @override
  State<PreviousQuizContest> createState() => _PreviousQuizContestState();
}

class _PreviousQuizContestState extends State<PreviousQuizContest> {
  bool loading = true;
  List<Datum> result = [];
  bool isLoading = true;
  @override
