...
import 'package:railway_super_app/User/SignUp/SignUp/SignUp.dart';
...
class OTPVerification extends StatefulWidget {
  String? value;
  OTPVerification({Key? key, this.value}) : super(key: key);
  @override
    ...
    if (response.statusCode == 200) {
      if (jsonDecode(response.body)['code'] == 500) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => Registration(email: widget.value)),
        );
      }
    } else {
      // ignore: use_build_context_synchronously
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  "Enter OTP that has been send to your registered Email.OTP Will be Expired in 5minutes",
