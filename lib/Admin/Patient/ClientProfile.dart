...
import 'package:admin_dashboard/Admin/Patient/AllCLients/AllClients_controller.dart';
...
class _ClientProfileState extends State<ClientProfile> {
  ...
  getData() async {
    ...
    String url = Admin.client_profile + '?customer=' + widget.value;
    if (token != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: const Text('User Detail not Found'),
  ...
  final items = ['Enable', 'Disable'];
  String? selectedItems = 'Enable';
  postData() async {
                            ...
                            children: <Widget>[
                              controller.state == StateEnum.loading
                                  ...
                                  : controller.state == StateEnum.success
                                      ? (controller.model!.clientDetails ==
                                                  null ||
                                              controller.model!.clientDetails!
                                                  .isEmpty)
                                          ? Center(
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: DropdownButton<
                                                                          ...
                                                                          items: items
                                                                              .map((item) => DropdownMenuItem<String>(value: item, child: Text(item, style: GoogleFonts.poppins(color: Colors.white, fontSize: 12))))
                                                                              .toList(),
                                                                          onChanged: (item) =>
                                                                              setState(() => selectedItems = (postData())),
                                                                        ),
                                                                      ),
                                                                    ),
                                                                  ]),
