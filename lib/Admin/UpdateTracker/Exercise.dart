...
class UpdateExercise extends StatefulWidget {
  @override
  UpdateExerciseState createState() => UpdateExerciseState();
}

class UpdateExerciseState extends State<UpdateExercise> {
  TextEditingController _nameController = TextEditingController();
  TextEditingController _urlController = TextEditingController();
  bool isLoading = true;
  postData(
      String tracker, String stage, String subModuleName, String url) async {
    ...
    if (token != null) {
      ...
      if (res.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Exercise not Submitted ,Please Try again'),
      ...
      children: <Widget>[
        Container(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              postData("Exercise", selectedItems.toString(),
