...
class ClientSubscriptionController with ChangeNotifier {
  ClientSubscriptionController(this.context) {
    fetchAllClients();
  }

  BuildContext context;

  SubscriptionClientModel? model;
  List<Client>? clients;
    ...
    if (userdetails != null) {
      if (userdetails.token != null) {
        ...
        if (response is bool) {
          ...
          model = SubscriptionClientModel.fromJson(response);
