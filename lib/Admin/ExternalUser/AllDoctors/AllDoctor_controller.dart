...
class AllDoctorController with ChangeNotifier {
  AllDoctorController(this.context) {
    fetchAllSales();
  }

  BuildContext context;

  AllDoctorsModel? model;
  List<Doctors>? sales;
    ...
    if (userdetails != null) {
      if (userdetails.token != null) {
        ...
        if (response is bool) {
          ...
          model = AllDoctorsModel.fromJson(response);
