...
class AllConsultant extends StatefulWidget {
  @override
  _AllConsultantState createState() => _AllConsultantState();
}
...
class _DataState extends State<Data> {
  ...
  postData() async {
    String appointmentId = widget.consultant.user.toString();
      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            Padding(
              padding: const EdgeInsets.all(10.0),
              child: widget.consultant.profilePic == null
                  ? CircleAvatar(
                  ...
                  : CircleAvatar(
                      ...
                      backgroundImage: NetworkImage(
                        widget.consultant.profilePic.toString(),
                      ),
                      radius: 35,
                    ),
            ),
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  Text(
                    (widget.consultant.name.toString().capitalize()),
                    style: GoogleFonts.poppins(
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                        "Email : " +
                            (widget.consultant.email ?? "Not Available"),
                        style: GoogleFonts.poppins(
                          textStyle: const TextStyle(
                            fontSize: 12,
                            color: Colors.lightBlueAccent,
                  ...
                  Column(
                    children: <Widget>[
                      Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: <Widget>[
                            if (widget.consultant.accountStatus == true) ...[
                              Text(
