...
class ClientThisMonthController with ChangeNotifier {
  ClientThisMonthController(this.context) {
    fetchClientThisMonth();
  }
  BuildContext context;
  ClientThisMonthModel? model;
  ...
  fetchClientThisMonth() async {
    changeState(StateEnum.loading);
    LoginModel? userdetails = await Global.getUserDetails();
    if (userdetails != null) {
      if (userdetails.token != null) {
        String url = consultantAPi.consultant_thisMonth;
        ...
        if (response is bool) {
          ...
          model = ClientThisMonthModel.fromJson(response);
          print(response);
